...
if __name__ == '__main__':
    #添加参数
    argparse = argparse.ArgumentParser("图像选点")
    argparse.add_argument('-img_dir', '-i' ,type=str, default=r'C:\Users\13053\OneDrive\Code\image_tools\Image_20250412151039275.jpg', help='图片路径')
    args = argparse.parse_args()

    app = QApplication(sys.argv)
    viewer = ImageViewer(args.img_dir)
    viewer.show()
    sys.exit(app.exec_())